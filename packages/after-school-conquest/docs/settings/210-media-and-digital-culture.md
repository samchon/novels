...
<!-- @evidenceReview principles/common.md#purpose-fit #a5876aa Read the overview and all 12 H2s; the opening and weakest unit “# Media and Digital Culture” were checked against the delivery promise. -->
...
<!-- @evidenceReview obligations/common.md#scope-preservation #cc1e606 Read the complete “Devices and ownership” H2 from Status through its final boundary. Its first operating statement is “Phones, tablets, laptops, school terminals, cameras, audio recorders, printers, and public kiosks have different owners, permissions, batteries, warranties, and data risks. A devic”; checked the stated owner, boundary, and explicit exclusion against this unit. -->
...
<!-- @evidenceReview obligations/common.md#scope-preservation #cc1e606 Read the complete “Connectivity and channel hierarchy” H2 from Status through its final boundary. Its first operating statement is “The group distinguishes school portal, official email, club chat, private message, public post, phone call, printed notice, and face-to-face report. Each channel has an issuer, aud”; checked the stated owner, boundary, and explicit exclusion against this unit. -->
...
<!-- @evidenceReview obligations/common.md#scope-preservation #cc1e606 Read the complete “Account security and handoff” H2 from Status through its final boundary. Its first operating statement is “Passwords, recovery contacts, multifactor devices, shared drives, and admin roles are assigned to named owners. A student may be a contributor without being an administrator. Accou”; checked the stated owner, boundary, and explicit exclusion against this unit. -->
...
<!-- @evidenceReview obligations/common.md#scope-preservation #cc1e606 Read the complete “Group chat governance” H2 from Status through its final boundary. Its first operating statement is “A group chat has purpose, members, moderators, language expectations, response norms, retention, and exit route. A moderator can remove spam or protect a participant but cannot rew”; checked the stated owner, boundary, and explicit exclusion against this unit. -->
...
<!-- @evidenceReview obligations/common.md#scope-preservation #cc1e606 Read the complete “Maps, photos, and location precision” H2 from Status through its final boundary. Its first operating statement is “A digital map can show a route, landmark, timestamp, coordinate, accessibility note, or proposed change. Scale, orientation, update date, and source are visible. A map is not an in”; checked the stated owner, boundary, and explicit exclusion against this unit. -->
...
<!-- @evidenceReview obligations/common.md#scope-preservation #cc1e606 Read the complete “Audio, captions, and accessible media” H2 from Status through its final boundary. Its first operating statement is “Audio includes speech, noise, silence, background announcements, and identity cues. Captions identify speaker where useful, preserve meaningful non-speech sound, and mark uncertain”; checked the stated owner, boundary, and explicit exclusion against this unit. -->
...
<!-- @evidenceReview obligations/common.md#scope-preservation #cc1e606 Read the complete “Search, sources, and algorithmic ranking” H2 from Status through its final boundary. Its first operating statement is “Search results, recommendation feeds, map rankings, and auto-complete suggestions are sorted outputs, not neutral truth. The founders record query, date, language, location setting”; checked the stated owner, boundary, and explicit exclusion against this unit. -->
...
<!-- @evidenceReview obligations/common.md#scope-preservation #cc1e606 Read the complete “Misinformation and correction” H2 from Status through its final boundary. Its first operating statement is “A false claim may arise from error, satire, translation, outdated information, impersonation, or deliberate manipulation. The founders identify the claim, source chain, affected au”; checked the stated owner, boundary, and explicit exclusion against this unit. -->
...
<!-- @evidenceReview obligations/common.md#scope-preservation #cc1e606 Read the complete “School media and student publication” H2 from Status through its final boundary. Its first operating statement is “Student newspapers, announcements, displays, yearbooks, and club pages have editors, advisers, publication scope, and correction rules. A school channel can publish a student’s wor”; checked the stated owner, boundary, and explicit exclusion against this unit. -->
...
<!-- @evidenceReview obligations/common.md#scope-preservation #cc1e606 Read the complete “Public comments and moderation” H2 from Status through its final boundary. Its first operating statement is “Public comments can contain testimony, advice, abuse, advertising, or unresolved disagreement. A moderator states what is removed, preserved, appealed, or disclosed. Deleting a com”; checked the stated owner, boundary, and explicit exclusion against this unit. -->
...
<!-- @evidenceReview obligations/common.md#scope-preservation #cc1e606 Read the complete “Data after graduation” H2 from Status through its final boundary. Its first operating statement is “Graduation changes student accounts, school mailing lists, room permissions, group roles, and access to records. A former student’s personal archive may remain theirs, but school-o”; checked the stated owner, boundary, and explicit exclusion against this unit. -->
...
<!-- @evidenceReview obligations/common.md#scope-preservation #cc1e606 Read the complete “Digital fatigue and humane availability” H2 from Status through its final boundary. Its first operating statement is “Notifications, bright screens, audio alerts, constant translation, and rapid replies consume attention. A founder may mute, delay, use paper, or request one consolidated message. A”; checked the stated owner, boundary, and explicit exclusion against this unit. -->
