...
Affection, fear, debt, kinship, office, and rivalry can coexist. The settings graph must name the channel, its participants, the material support that sustains it, and the condition that can break it. A character's title never substitutes for the relationship's actual route of influence.
...
A secretary sees documents, a spouse sees domestic strain, a marshal sees orders and terrain, and a diplomat sees a negotiated audience. Their accounts overlap without becoming identical. Later scenes must preserve the difference between what a person knows, suspects, remembers, and chooses to say.
...
The Bonaparte family, Josephine's household, dynastic marriages, and imperial appointments must not be treated as one network with one motive. A favor can require money, office, marriage, silence, or future service. Settings must identify who gives, who receives, what is expected, and what happens when the expectation is refused.
...
Subordinates can correct, delay, flatter, resist, or reinterpret an order. Napoleon's impatience does not erase the institutional ability of a minister, marshal, ally, or clerk to shape an outcome. Later documents must establish the meeting, dispatch, or physical constraint through which correction could occur and must preserve cases where it failed.
...
An unanswered letter may be delayed, intercepted, lost, withheld, or unanswered. A later memoir may improve a line or rationalize a decision. Settings must retain document date, recipient, transmission state, and retrospective bias before assigning emotional certainty.
...
A household separated by war has different information and labor from one in the same room. A marshal's loyalty under victory is not identical to loyalty under defeat; a family member's protection can disappear with a title. Later storylines must specify the event, distance, resource, and institutional change that produces a new relationship state.
...
This file supplies relationship mechanics and evidence limits. Downstream units must cite the specific person, document, office, household, or event they use and must not convert this general grammar into an unsupported dialogue or motive.
