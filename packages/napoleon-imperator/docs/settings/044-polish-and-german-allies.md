...
French alliance language cannot erase local calculation. Settings must identify treaty, contingent, command channel, payment, territory, and public cost. A unit can fight bravely while its government negotiates another course.
...
A soldier, noble, town, and diplomatic representative may hear a different meaning in French support. Later scenes must identify the promise, audience, document, military contribution, and uncertainty over implementation. Polish agency cannot be reduced to grateful service or disappointed betrayal.
...
An order must pass through a ruler, minister, military staff, and local office. Settings must distinguish contingent command from civil sovereignty and must show who pays, recruits, requisitions, and translates French policy.
...
A contingent can understand a tactical command and reject a political purpose, or obey a government instruction that conflicts with French timing. Later units must name language, medium, receipt, and chain of command before claiming cohesion or defection.
...
This file supplies allied agency and translation mechanics. Later narratives must preserve a contingent's national purpose, material support, commander, and political exposure rather than using “allied” as a generic identity.
