...
An alliance is a document, a cabinet decision, a military timetable, and a public argument. Austria, Russia, Prussia, Britain, and smaller states pursue distinct interests. A French victory can dissolve one coalition while creating another; a treaty can leave local populations under new authority.
...
An envoy reports what he saw and what he is permitted to say. Translation can change legal force or emotional tone. The novel must identify whether a claim is an offer, demand, threat, private assurance, or public communiqué.
...
Residents can obey soldiers while rejecting the new state; collaborators and resistors coexist. A treaty's map cannot erase confiscation, requisition, hostage-taking, or local administration. Each occupied territory needs its own legal and social owner.
...
Signature does not instantly move a garrison or return property. Secret articles may be unknown to soldiers and civilians; translation can change terms; a defeated state may obey one clause while resisting another. The novel must distinguish article, instruction, interpretation, and implementation.
...
Ceremony, language, seals, escort, delay, and interception shape negotiations. A private assurance may conflict with a public communiqué. Scenes must identify who was present, who translated, what was written, and what remained uncertain.
...
Residents can use French institutions while rejecting French rule. Collaborators, resisters, neutral traders, and coerced officials coexist. A map colored for empire cannot substitute for a local government record or a household's experience.
...
An armistice may leave prisoners, supplies, and troops facing one another. Peace may preserve economic coercion or create a new coalition. Later campaign owners must carry unresolved claims into the next diplomatic state instead of treating a signature as emotional closure.
