...
The opening of a new unit lets the reader know which character, goal, question, or consequence from the previous unit to keep tracking. Across a large move of time, place, or focus, show in time why the move is needed now and where the earlier change remains — through a connected person, object, consequence, misunderstanding, or repeated image that changes present action, not a bare date and place name — so the reader never re-orients as if starting a new work.
