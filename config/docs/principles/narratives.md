...
The last event of a local branch, an aftermath, a side event of a parallel front, or the final scene of the work need not launch a next event: it may close its pressure at a real cost, change the meaning of its parent unit, or leave a state, contrast, or piece of information collected later.
