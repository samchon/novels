...
| --- | --- | --- | --- | --- | --- | --- |
| `napoleon-imperator` | settings | `disabled` | — | clean (empty) | 0 | hold for the release, then draft canon from an empty directory |
