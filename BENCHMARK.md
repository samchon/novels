...
| --- | --- | --- | --- | --- | --- | --- |
| `napoleon-imperator` | settings | `disabled` | 20 files, 226 H2 | clean (nothing enforced) | 0 | close the 1806-1811 depth gap and the sourcing debt; hold the `evidence` transition for the release |
